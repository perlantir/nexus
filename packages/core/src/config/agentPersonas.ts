...
export const AGENT_PERSONAS: Record<string, AgentPersona> = {
  ...
  makspm: {
    ...
    primaryTags: ['specs', 'roadmap', 'delegation', 'qa', 'priorities', 'requirements', 'milestones', 'sprints', 'acceptance-criteria', 'coordination', 'product', 'planning', 'task', 'release', 'scheduling'],
    excludeTags: ['solidity', 'blockchain', 'devops', 'ci-cd', 'design', 'typography', 'on-chain', 'defi', 'smart-contract', 'figma', 'openclaw'],
